...
class SearchBar extends Component {
        ...
        currentState => {
          return {
            searchLocation: {
              ...
              lat: browserPosition[0],
              lon: browserPosition[1]
            }
          };
        },
        () => {
  ...
  fetchGeolocation = () => {
    api.getGeoLocation(this.state.searchInput).then(data => {
  ...
  fetchCrimeData = () => {
    api.getCrimeData(this.state.searchLocation).then(data => {
  ...
  fetchYearlyData = () => {
    ...
    let monthlyCount = [];
    api
      .getYearlyData(this.state.searchLocation)
      .then(res => {
        res.forEach(obj => {
